...
### 1. Дашборд №1: Аналіз продажів та клієнтів  (Sales and customer analysis)
 ...
 - **Продажі за країнами (Text Table):** Детальна таблиця розподілу кількості замовлень, виторгу, чистого прибутку та об'єму кави (в кг) за країнами, типами обсмаження та сортами кави.  
 - **Найкращі клієнти за рівнем продажів (Highlight Table):** Динамічна таблиця найкращих покупців з можливістю регулювання їх кількості за допомогою параметра `Select Top N Customers`.  
 - **Найкращі клієнти за обраним показником (TreeMap):** Візуалізація клієнтської бази, де користувач може самостійно обирати метрику ранжування (Продажі, Прибуток, Кількість замовлень, Маса) через параметр `Select Measure`.  
 - **Розподіл замовлень за країнами (Box-Plot):** Аналіз розкиду ваги замовлень по кожній країні для виявлення споживчих аномалій та медіанного чека.  
