...
### 1. Дашборд №1: Аналіз продажів та клієнтів | Sales and customer analysis  
  
 - **Продажі за країнами | Sales by country | (Text Table):** Детальна таблиця розподілу кількості замовлень, виторгу, чистого прибутку та об'єму кави (в кг) за країнами, типами обсмаження та сортами кави.  
 - **Найкращі клієнти за рівнем продажів | Top customers by sales level | (Highlight Table):** Динамічна таблиця найкращих покупців з можливістю регулювання їх кількості за допомогою параметра `Select Top N Customers`.  
 - **Найкращі клієнти за обраним показником | Top customers by measure | (TreeMap):** Візуалізація клієнтської бази, де користувач може самостійно обирати метрику ранжування (Продажі, Прибуток, Кількість замовлень, Маса) через параметр `Select Measure`.  
 - **Розподіл замовлень за країнами | Distribution of orders by country | (Box-Plot):** Аналіз розкиду ваги замовлень по кожній країні для виявлення споживчих аномалій та медіанного чека.  
...
3. Проєкт також опубліковано на Tableau Public: [Coffee Sales Analysis](https://surl.li/fhpoop)  
