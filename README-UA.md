...
### 1. Дашборд №1: Аналіз продажів та клієнтів  
 ...
 - **Аналіз ТОП-клієнтів за роками:** Динамічна таблиця найкращих покупців з можливістю регулювання їх кількості за допомогою параметра `Select Top N Customers`.  
